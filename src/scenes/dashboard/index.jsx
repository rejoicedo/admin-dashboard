...
import { DownloadOutlined, Email, PointOfSale, Traffic, PersonAddAlt } from '@mui/icons-material';
  ...
  return (
    ...
    <Box m="20px">
      ...
      <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="140px" gap="20px">
        ...
        <Box gridColumn="span 3" backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center">
          <StatBox title="431,225" subtitle="Sales Obtained" progress="0.5" increase="+21%" icon={
        ...
        <Box gridColumn="span 3" backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center">
          <StatBox title="32,441" subtitle="New Clients" progress="0.3" increase="+5%" icon={
            <PersonAddAlt sx={{ color: colors.greenAccent[600], fontSize: "26px"}} />
          } />
        </Box>

        
        <Box gridColumn="span 3" backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center">
          <StatBox title="1,325,134" subtitle="Traffic Inbound" progress="0.75" increase="+14%" icon={
        ...
        <Box gridColumn="span 8" gridRow="span 2" backgroundColor={colors.primary[400]}>
          ...
          <Box gridColumn="span 4" gridRow="span 2" backgroundColor={colors.primary[400]} p="30px">
              ...
              <Box display="Flex" flexDirection="column" alignItems="center" mt="25px">
                ...
                <Typography variants="h5" color={colors.greeenAccent[500]} sx={{ mt: "15px" }}>
